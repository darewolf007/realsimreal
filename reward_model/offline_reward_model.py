...
def train_offline_reward(train_loader, val_loader, base_path, logger=None, task_name = "Pick up banana"):
    ...
    step = 0
    best_accuracy = 0.0
    best_model_path = os.path.join(base_path, './experiments/offline_reward_model/' + task_name + '/best_reward_model.pth')
