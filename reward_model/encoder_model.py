    ...
    def dino_embed(self, obs):
        if self.dino is None:
            ...
            if DINO is not None:
                ...
                self.din = torch.hub.load('../pre_train/dinov2', 'dinov2_vits14', source='local', pretrained=False)
                self.din.load_state_dict(torch.load('../pre_train/dinov2_vits14.pth')).to(obs.device)
                DINO = self.dino
