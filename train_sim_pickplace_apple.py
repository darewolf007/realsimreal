...
class PickPlaceSimulation(RealInSimulation):
...
def set_params(args):
    ...
    apple_pose = np.array([-0.3467163,  0.44472795,  0.04,  0.707, 0, 0,  0.707])
    bowl_pose = np.array([-0.49747796,  0.2556481,  0.04,  1, 0, 0,  0])
